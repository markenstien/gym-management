...
<li class="nav-item">
    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#workoutCollapse"
        aria-expanded="true" aria-controls="workoutCollapse">
        <i class="fas fa-fw fa-cog"></i>
        <span>Workouts</span>
    </a>
    <div id="workoutCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="<?php echo _route('workout:create', null)?>">Add Workout</a>
            <a class="collapse-item" href="<?php echo _route('workout-set-builder:index', null)?>">Workout Sets</a>
        </div>
    </div>
</li>